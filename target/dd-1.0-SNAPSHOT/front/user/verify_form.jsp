...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="${pageContext.request.contextPath}/front/user/changeUserStatus" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<div class="mess reduce_h">
						我们给您发送了验证邮件，邮件地址为：
						<span class="red"><span id="lblEmail">${requestScope.email}</span>
						</span>
						<span class="t1"> 
						请登录您的邮箱收信。
						</span>
					...
					<div class="mess">
							...
							<span id="errorMsg" class="no_right">${requestScope.errorMsg}</span>
					</div>
